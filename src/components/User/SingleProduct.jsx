...
// // //         console.log(
// // //           `length of reviews from product: ${singleProduct.reviews.length}`
// // //         );
...
// // //     console.log(
// // //       `Selected purchase product quantity is : ${purchaseProudct.quantity}`
// // //     );
// // //     console.log(
// // //       `Selected purchase product price is : ${purchaseProudct.price}`
// // //     );
...
// // //                   className="btn btn-outline glass btn-ghost mr-4"
// // //                 >
// // //                   -
// // //                 </button>
// // //                 Quantity: {quantity}
...
// // //                   className="btn btn-outline glass btn-ghost ml-4"
// // //                 >
// // //                   +
// // //                 </button>
// // //                 <br />
// // //                 <button
// // //                   className="btn btn-primary btn-wide font-bold mt-8 mb-8"
...
// // //               ) : (
// // //                 <span className="input-icon">
// // //                   <IconButton onClick={handleReview} style={{ color: "white" }}>
// // //                     <SendIcon />
// // //                   </IconButton>
// // //                 </span>
// // //               )
...
// //             <p className="py-6">{product.description}</p>
// //             <p className="text-bold mb-3" style={{color:"green"}}>Price: Rs {product.price}</p>
// //             {isUserLogin && (
// //               <>
// //                 <button
// //                   onClick={handleDecrement}
...
// //                 <br />
// //                 <button
// //                   className="btn btn-wide font-bold mt-8 mb-8"
// //                   onClick={handleAddToCart}
...
// //               edit.isEdit ? (
// //                 <span className="input-icon">
// //                   <IconButton onClick={handleEdit} style={{ color: "black" }}>
// //                     <EditIcon />
// //                   </IconButton>
// //                 </span>
// //               ) : (
...
//           style={{ backgroundColor: "#003366", color: "white", marginTop: "20px" }}
//         >
//           {showReviewInput ? "Cancel" : "Add a Review"}
//         </Button>
//         {showReviewInput && (
//           <div className="send-review-section mt-4">
//             <Input
//               type="text"
//               placeholder="Write a review ..."
//               onChange={
...
function SingleProduct() {
  ...
  const handleAddToCart = async (e) => {
    ...
    if (quantity === 0) {
      return window.alert("Please, select quantity first");
    }
            ...
            reviews.map((review) => (
              <div key={review._id}>
                <div className="chat chat-start mb-4">
                  ...
                  <div
                    style={{ color: "white" }}
                    className="chat-header text-info"
                  >
                    {review.userName}
                  </div>
                  <div className="chat-bubble">
